...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Empty", width : 640, height : 480},Main.initialized);
};
...
var kha__$Assets_SoundList = function() {
	this.names = ["bomb1","bomb2","bomb3","bomb4","engine_blimp","engine_plane","explode1","explode10","explode11","explode12","explode2","explode3","explode4","explode5","explode6","explode7","explode8","hit","miss","music","explode9"];
